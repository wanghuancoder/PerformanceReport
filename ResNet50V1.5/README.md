...
因此，本次测试主要关注Resnet50V1.5在Paddle下，训练期间的吞吐性能，即单位时间内能够完成训练的图片数量（images/sec）。
测试中，我们选择如下3个维度，测试Resnet50V1.5在Paddle下的吞吐性能：
...
- BatchSize
   ...
   此外，还测试了Paddle Resnet50V1.5在FP32、AMP精度模式下支持的最大BatchSize，及对应的吞吐性能。
